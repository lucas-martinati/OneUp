  ...
  test: {
    ...
    coverage: {
      ...
      exclude: [
        ...
        'src/pages/Dashboard/components/DashboardSlide.jsx',
        'src/pages/Dashboard/components/DashboardSlideRenderer.jsx',
        'src/pages/Dashboard/components/ProPaywall.jsx',
        'src/pages/Dashboard/components/SessionBubble.jsx',
        ...
        'src/pages/Dashboard/components/CategoryNav.jsx',
        'src/pages/Dashboard/components/DashboardNavBar.jsx',
