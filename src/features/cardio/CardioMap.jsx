...
export const CardioMap = React.memo(({ gpsTrack, height = 'var(--cardio-map-height, clamp(60px, 18cqh, 200px))', style: styleProp, onShowFullscreen, onExpandChange, session }) => {
