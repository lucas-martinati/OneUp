...
const MEDALS = {
    1: { cls: styles.gold, border: PALETTE.gold },
    2: { cls: styles.silver, border: PALETTE.silver },
    3: { cls: styles.bronze, border: PALETTE.bronze },
};
                ...
                return (
                    ...
                    >
                        ...
                        <div className={styles.pName}>
                            ...
                            {isPerfect && <Star size={12} color={PALETTE.amber} fill={PALETTE.amber} className={styles.perfectStar} />}
                        </div>
