                    ...
                    <>
                        ...
                        {sorted.length >= 3 && (
                            <div style={{
                                ...
                                gap: '8px', marginBottom: '8px', paddingTop: '8px'
                            }}>
                                {[1, 0, 2].map(idx => {
                                    ...
                                    const heights = { 1: '100px', 2: '80px', 3: '68px' };
                                    const colors = { 1: '#fbbf24', 2: '#c0c0c0', 3: '#cd7f32' };
                                    const iconSizes = { 1: 22, 2: 18, 3: 16 };
                                    const avatarSizes = { 1: '48px', 2: '40px', 3: '36px' };
                                    return (
                                        <div
                                            key={entry.uid}
                                        ...
                                        >
                                            ...
                                            <div style={{ position: 'relative' }}>
                                                <div style={{
                                                    width: avatarSizes[rank], height: avatarSizes[rank],
                                    ...
                                    {entry.photoURL ? (
                                        ...
                                        <div style={{
                                            ...
                                            <User size={parseInt(avatarSizes[rank]) / 2} color={colors[rank]} />
                                                ...
                                                {rank === 1 && (
                                                    <Crown size={16} color="#fbbf24" style={{
                                            ...
                                            <span style={{
                                                ...
                                                color: isMe ? colors[rank] : 'var(--text-primary)',
                                            ...
                                            <div style={{
                                                ...
                                                background: `linear-gradient(180deg, ${colors[rank]}25, ${colors[rank]}08)`,
                                                ...
                                                <span style={{
                                                    fontSize: '1.2rem', fontWeight: '800', color: colors[rank]
                                                }}>
                                                    #{rank}
                                                </span>
                                                <span style={{
                                                    ...
                                                    {getReps(entry).toLocaleString('fr-FR')}
                                                </span>
                                            </div>
                                        </div>
                                    );
                        ...
                        {sorted.slice(sorted.length >= 3 ? 3 : 0).map((entry, i) => {
                            const rank = sorted.length >= 3 ? i + 4 : i + 1;
                            const isMe = entry.uid === currentUid;
